...
from db.crud import delete_customer
from db.crud import delete_service
from db.crud import delete_stylist
from db.crud import delete_work_schedule
...
from db.crud import get_stylist
from db.crud import get_work_schedule
from db.crud import update_appointment
from db.crud import update_customer
from db.crud import update_service
from db.crud import update_stylist
from db.crud import update_work_schedule
